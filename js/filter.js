...
// --------------------------

  {
        ...
        response.result.values.forEach((row, index) => {
          ...
          if (index === 0) {
            ...
            row.forEach((value, ind) => {
              filterBar += '<th  col-index =' + (ind+1) + '><select class="table-filter" onchange="filter_rows()"><option value="all">' + value + ' </option></select> </th>';
            })
            document.getElementById("filterContainer").innerHTML = filterBar;
    ...
    // Auto search of player names (Codes are commented below, Should be added here when needed)
    // ----------------------------------------------------------------------------------------
  ...
  // Test code (Store for future test)
...
// -------------------------------------------------------------------
  ...
  //-----------------------------
    function search_animal() {
      ...
      let x1 = document.querySelectorAll('#emp-table > tbody > tr');

      x1.forEach((value) => {

        const tdArray = value.getElementsByTagName('td');

        for(let i = 0; i < tdArray.length; i++) {

          if(tdArray[i].innerHTML.toLowerCase().includes(input)) {
      ...
      // Test code for search bar (Can be removed)
      // -----------------------------------------
...
// Player search auto complete codes
// ---------------------------------
